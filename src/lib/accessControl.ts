...
const ROUTE_ACCESS_RULES: RouteAccessRule[] = [
  { prefix: "/", allow: ["*"] },
  { prefix: "/dashboard", allow: ["*", "UMUM"] },
  { prefix: "/job", allow: ["*", "UMUM"] },
  ...
  { prefix: "/dashboard/prepress", allow: ["*", "UMUM", ...ADMIN_ROLES, ...ROLE_GROUPS.prepress] },
  ...
  { prefix: "/panel/prepress", allow: ["*", "UMUM", ...ADMIN_ROLES, ...ROLE_GROUPS.prepress] },
  ...
  { prefix: "/panel", allow: ["*", "UMUM", ...ADMIN_ROLES, ...OPERATIONAL_ADMIN_ROLES, ...ROLE_GROUPS.dt, ...ROLE_GROUPS.dg, ...ROLE_GROUPS.prepress, ...ROLE_GROUPS.support, ...ROLE_GROUPS.qc] },
