...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="bg-white p-5 rounded-[2rem] sm:rounded-[2.5rem] shadow-sm border border-slate-100 flex flex-col xl:flex-row items-center justify-between gap-6 transition-all hover:shadow-md">
